...
class CreateArtistModal extends StatelessWidget {
  const CreateArtistModal({super.key});
      ...
      child: Stack(
        children: [
          AppModal(
            ...
            body: Form(
              key: context.read<CreateArtistViewModel>().formKey,
              child: SingleChildScrollView(
                child: Padding(
                  padding: const EdgeInsets.all(24.0),
                  child: Consumer<CreateArtistViewModel>(
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          AppButton(
                            ...
                            onPressed: () =>
                                viewModel.createArtist(context, false),
                          ),
                        ],
                      );
                    },
          ...
          Selector<CreateArtistViewModel, bool>(
