...
struct PlayerStatus {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PlayerStatus? {
    let playing = pigeonVar_list[0] as! Bool
    let pos = pigeonVar_list[1] is Int64 ? pigeonVar_list[1] as! Int64 : Int64(pigeonVar_list[1] as! Int32)
    let positionMs = pigeonVar_list[2] is Int64 ? pigeonVar_list[2] as! Int64 : Int64(pigeonVar_list[2] as! Int32)
    let bufferedPositionMs = pigeonVar_list[3] is Int64 ? pigeonVar_list[3] as! Int64 : Int64(pigeonVar_list[3] as! Int32)
    let state = pigeonVar_list[4] as! MelodinkHostPlayerProcessingState
    let loop = pigeonVar_list[5] as! MelodinkHostPlayerLoopMode
  ...
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 129:
      ...
      if let enumResultAsInt = enumResultAsInt {
        return MelodinkHostPlayerProcessingState(rawValue: enumResultAsInt)
      }
      return nil
    case 130:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        return MelodinkHostPlayerLoopMode(rawValue: enumResultAsInt)
      }
      return nil
    case 131:
...
private class MessagesPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? MelodinkHostPlayerProcessingState {
      super.writeByte(129)
      super.writeValue(value.rawValue)
    } else if let value = value as? MelodinkHostPlayerLoopMode {
      super.writeByte(130)
      super.writeValue(value.rawValue)
    } else if let value = value as? PlayerStatus {
      super.writeByte(131)
